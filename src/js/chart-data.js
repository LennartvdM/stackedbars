...
const TEXT_REFS = {
  ...
  H5: "Begeleding van de carrière-ontwikkeling van mensen met herkomst Buiten-Europa door opleiding en management-development",
  H6: "Begeliding van de carrière-ontwikkeling van mensen met herkomst Buiten-Europa door middel van coaching en mentoring",
  ...
  // Climate (M1-M6) - Using M for klimaat to avoid conflict with C
...
// Compact chart data using reference codes
const chartData = {
  leadership: {
    title: "Leiderschap",
    items: [
...
// Helper function to resolve text references
function resolveTextReferences(data) {
  const resolved = JSON.parse(JSON.stringify(data)); // Deep clone
...
// Export both the compact data and the resolver
